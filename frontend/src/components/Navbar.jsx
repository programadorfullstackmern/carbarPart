...
// Estilos en línea para mayor control
...
const AppNavbar = () => {
  ...
  const { totalItems } = useCart(); // Obtenemos el total de items
          ...
          <>
            ...
            <Nav.Link as={Link} to="/cliente/carrito" className="d-flex align-items-center position-relative">
              <div className="position-relative">
                ...
                {/* Mostrar badge siempre, pero con estilo secundario si no hay items */}
                <Badge 
                  pill 
